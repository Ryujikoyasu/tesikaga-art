...
def get_base_config():
    return {
        ...
        "ooluri": { # OK
            ...
            "color_pattern": [['b', 1], ['a', 2], ['b', 1]], "chirp_color_pattern": [['b', 1], ['a', 2], ['b', 1]],
        ...
        "oohakucho": { # OK
            ...
            "color_pattern": [['b', 2], ['a', 2], ['b', 2]], "chirp_color_pattern": [['a', 1], ['b', 4], ['a', 1]],
        ...
        "ojirowasi": { # OK
            ...
            "color_pattern": [['b', 2], ['a', 2], ['b', 2]], "chirp_color_pattern": [['a', 3], ['b', 3]],
        ...
        "shimafukuro": { # NEW ACCENT: Deeper, more greenish
            ...
            "color_pattern": [['a', 5]], "chirp_color_pattern": [['a', 5]],
        ...
        "kumagera": { # NEW ACCENT: User-specified red
            ...
            "color_pattern": [['a', 3]], "chirp_color_pattern": [['a', 3]],
        ...
        "tancho": { # OK
            ...
            "color_pattern": [['b', 2], ['a', 1], ['b', 2]], "chirp_color_pattern": [['a', 1], ['b', 1], ['a', 1], ['b', 1], ['a', 1]],
        ...
        "nogoma": { # NEW BASE & ACCENT: Earthy brown and vivid orange
            ...
            "color_pattern": [['b', 1], ['a', 1], ['b', 1]], "chirp_color_pattern": [['a', 3]],
        ...
        "benimashiko": { # OK
            ...
            "color_pattern": [['a', 1], ['b', 1], ['a', 1]], "chirp_color_pattern": [['a', 1], ['b', 2]],
